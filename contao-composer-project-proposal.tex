...
Der Umfang des Antrags würde würde das Jahresbudget der Association deutlich sprengen. Deshalb wird dieser Antrag in \uquot{Entwicklungspakete} aufgesplittet, die dann zur Förderung eingereicht werden oder durch andere Unternehmen gefördert werden können.
...
Dabei helfen uns die \uquot{Entwicklungspakete} die zeitgleich zu einem agilen Entwicklungsmodel führen. Nach jedem Entwicklungsschritt können wir ein Resümee ziehen und gemeinsam die nächste Stufe planen.
...
\subsection*{Tim \uquot{timbec} Becker, \href{mailto:tim@westwerk.ac}{tim@westwerk.ac}}
...
\subsection*{Kim \uquot{k-webdesign} Wormer, \href{mailto:info@kim-wormer.de}{info@kim-wormer.de}}
...
\subsection*{Kirsten \uquot{katgirl} Roschanski, \href{mailto:kirsten@kirsten-roschanski.de}{kirsten@kirsten-roschanski.de}}
...
\subsection*{Marc \uquot{MacKP} Reimann, \href{mailto:reimann@mediendepot-ruhr.de}{reimann@mediendepot-ruhr.de}}
...
\subsection*{Carolina \uquot{Lucina} Koehn, \href{mailto:ck@kikmedia.de}{ck@kikmedia.de}}
...
\subsection*{Leo \uquot{leo} Feyer, \href{mailto:leo@contao.org}{leo@contao.org}}
...
\footnote{\hreflink{https://github.com/contao-community-alliance/composer-client/milestones/1.13\%20stable\%20\%22npm/bower\%20support\%22}}
...
\textbf{Ticket:} contao-community-alliance/composer-reposititory\#1\footnote{\hreflink{https://github.com/contao-community-alliance/composer-reposititory/issues/1}}
...
\textbf{Ticket:} contao-community-alliance/composer.json-generator\#1\footnote{\hreflink{https://github.com/contao-community-alliance/composer-reposititory/issues/1}}
...
\textbf{Ticket:} contao-community-alliance/database-update-tool\#1\footnote{\hreflink{https://github.com/contao-community-alliance/database-update-tool/issues/1}}
